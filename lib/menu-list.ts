      ...
      menus: [
        {
          ...
          label: "Stories",
          active: pathname === "/staff/student-works/stories",
          icon: SquareLibrary,
          submenus: [],
        },
        {
          ...
          active: pathname === "/staff/student-works/audio-podcasts",
          icon: AudioLines,
          submenus: [],
        },
        {
          ...
          active: pathname === "/staff/student-works/video-podcasts",
          icon: Clapperboard,
          submenus: [],
        },
        {
          ...
          label: "PKL Reports",
          active: pathname.includes("/staff/student-works/prakerin"),
          icon: Proportions,
          submenus: [],
        },
      ],
