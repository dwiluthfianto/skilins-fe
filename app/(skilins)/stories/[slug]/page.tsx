        ...
        <div className="md:container">
                ...
                <CardContent className="p-6">
                  <div className="flex justify-between items-center">
                    ...
                    <Button variant={"default"}>
                      ...
                      <Link href={novel.file_url}>Read book</Link>
                    </Button>
                  </div>
          ...
          <Card className=" py-8 lg:py-16 antialiased mt-10">
            <CardContent className="space-y-4">
              <LikeComponent likes={novel.likes} contentUuid={slug} />
              <CommentComponent comment={novel.comments} contentUuid={slug} />
            </CardContent>
          </Card>
        </div>
      </section>
...
export async function generateStaticParams() {
  ...
  while (hasMore) {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/contents/novels?page=${page}&limit=${limit}`
    );
